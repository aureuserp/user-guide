...
1. Go to **`Time Off → Management → Time Offs`** as shown in the below image.
   ...
   <ImagePopup src="/images1/time-off/time-offs-create.png" alt="Create Time-Offs" />
...
3. Action Buttons
   ...
   <ImagePopup src="/images1/time-off/time-offs-form.png" alt="Time-Offs Form" />

> Once submitted, the manager can **Approve or Refuse** from the list screen.

<ImagePopup src="/images1/time-off/time-offs-submit.png" alt="Time-Offs Submit" />
...
1. Navigate to **`Time Off → Management → Allocations`** as shown in the below image.
   ...
   <ImagePopup src="/images1/time-off/allocations-create.png" alt="Create Allocation" />
...
2. Fill in the details:
   ...
   - **_Allocation Type:_** Choose leave method:<br> **Regular** – Assign full leave amount at once<br> **Accrual** – Leave earned gradually over time
...
3. Action Buttons
   ...
   <ImagePopup src="/images1/time-off/allocations-form.png" alt="Allocation Form" />

> Just like time-off requests, leave allocations also support **Approve / Refuse** actions.

<ImagePopup src="/images1/time-off/allocations-submit.png" alt="Allocations Submit" />
