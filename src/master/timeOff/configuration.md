...
1. Navigate to **`Time Off → Configuration → Leave Types → New Leave Type`** as shown below.
   ...
   <ImagePopup src="/images1/time-off/config_leave.png" alt="Config. New Leave" />
...
2. Fill out the form:
   ...
   <ImagePopup src="/images1/time-off/leave_general.png" alt="General Leave" />
   ...
   <ImagePopup src="/images1/time-off/leave_config.png" alt="General Leave" />
...
1. Navigate to **`Time Off → Configuration → Accrual Plan → New Accrual Plan`** as shown below.
   ...
   <ImagePopup src="/images1/time-off/config_accrual.png" alt="Config. New Leave" />
...
2. Fill in:
   ...
   <ImagePopup src="/images1/time-off/general_accrual.png" alt="Config. New Leave" />
...
<ImagePopup src="/images1/time-off/milestone_accrual.png" alt="Config. New Leave" />

- Click **Manage Milestone**
- Click **New Leave Accrual Plan** and fill:
   <ImagePopup src="/images1/time-off/new_milestone_accrual.png" alt="Config. New Leave" />
  ...
  - **_Advanced Accrual Settings:_**
   ...
   <ImagePopup src="/images1/time-off/general_milestone_accrual.png" alt="Config. New Leave" />
...
1. Navigate to **`Time Off → Configuration → Public Holidays → New Public Holiday`** as shown below.
   ...
   <ImagePopup src="/images1/time-off/new_public.png" alt="Config. New Leave" />
...
2. Fill in:
   ...
   <ImagePopup src="/images1/time-off/general_public.png" alt="Config. New Leave" />
...
1. Navigate to **`Time Off → Configuration → Mandatory Days → New Mandatory Day`** as shown below.
   ...
   <ImagePopup src="/images1/time-off/new_mandatory.png" alt="Config. New Leave" />
...
2. Fill in:
   ...
   <ImagePopup src="/images1/time-off/general_mandatory.png" alt="Config. New Leave" />
...
<ImagePopup src="/images1/time-off/new_activity.png" alt="Config. New Leave" />
...
2. Fill in:
   ...
   <ImagePopup src="/images1/time-off/general_activity.png" alt="Config. New Leave" />
