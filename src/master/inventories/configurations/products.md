...
1. Navigate to **`Inventory → Configurations → Products → Categories`** as shown below:
   ...
   <ImagePopup src="/images1/inventory/categories_navigation.png" alt="Product Categories Navigation" />
...
2. Fill in the following fields:
   ...
   <ImagePopup src="/images1/inventory/category_routes_selection.png" alt="Category Routes Selection" />
...
1. Navigate to **`Inventory → Configurations → Products → Attributes`** as shown below:
   ...
   <ImagePopup src="/images1/inventory/attributes_navigation.png" alt="Product Attributes Navigation" />
...
2. Fill in the following fields:
   ...
   <ImagePopup src="/images1/inventory/attribute_values_entry.png" alt="Attribute Values Entry" />
...
1. Navigate to **`Inventory → Configurations → Products → Packaging`** as shown below:
   ...
   <ImagePopup src="/images1/inventory/packaging_navigation.png" alt="Warehouse Management Navigation" />
...
2. Fill in the following fields:
   ...
   <ImagePopup src="/images1/inventory/packaging_configuration.png" alt="Packaging Configuration" />
