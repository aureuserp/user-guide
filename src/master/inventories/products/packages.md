...
1. Navigate to **`Inventory → Products → Packages`** as shown below.
  ...
  <ImagePopup src="/images1/inventory/packages_navigation.png" alt="Packages Navigation" />
...
2. Fill in the following details:
  ...
  <ImagePopup src="/images1/inventory/create_package.png" alt="Create Package" />
...
<ImagePopup src="/images1/inventory/package_view.png" alt="Package View" />
