...
2. Fill in the form as per the following sections:
   ...
   - **_Sub Title:_** A short subtitle that appears below the main title on the blog post.
   ...
   - **_Meta Title:_** The title shown on search engine result pages (SERPs). It should be concise and descriptive.
