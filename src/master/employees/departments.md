...
1. Navigate to **`Employees → Departments → New Department`** as shown below.
   ...
   <ImagePopup src="/images1/employees/dep_create.png" alt="Department create" />
...
2. Fill in the following details in the form:
   ...
   <ImagePopup src="/images1/employees/dep_general.png" alt="Department create" />
...
<ImagePopup src="/images1/employees/dep_acreate.png" alt="Department create" />
