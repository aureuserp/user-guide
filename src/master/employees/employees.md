...
1. Navigate to **`Employees → Employees → New Employee`** as shown below.
  ...
  <ImagePopup src="/images1/employees/emp_create.png" alt="Employee create" />
...
2. Fill in the following fields:
  ...
  <ImagePopup src="/images1/employees/emp_general.png" alt="Employee create" />
  ...
  <ImagePopup src="/images1/employees/emp_work.png" alt="Employee create" />
  ...
  <ImagePopup src="/images1/employees/emp_private1.png" alt="Employee create" />
  ...
  <ImagePopup src="/images1/employees/emp_edu.png" alt="Employee create" />
   ...
   - **Citizenship Subsection**
    ...
    <ImagePopup src="/images1/employees/emp_citi.png" alt="Employee create" />
   ...
   - **Work Permit Subsection**
    ...
    <ImagePopup src="/images1/employees/emp_workp.png" alt="Employee create" />
  ...
  <ImagePopup src="/images1/employees/emp_settings1.png" alt="Employee create" />
  ...
  <ImagePopup src="/images1/employees/emp_addinfo.png" alt="Employee create" />
...
<ImagePopup src="/images1/employees/emp_view.png" alt="Employee create" />
...
2. Click **Add Skill**.
  <ImagePopup src="/images1/employees/emp_skill.png" alt="Employee create" />
...
3. Fill in:
   ...
   - **_Skill Level:_** Proficiency level.
    <ImagePopup src="/images1/employees/emp_skill2.png" alt="Employee create" />
4. Click **Create** to add the skill.

<ImagePopup src="/images1/employees/emp_skill3.png" alt="Employee create" />

### Manage Resumes

1. Click **Manage Resumes**.
2. Click **Add Resume**.
  <ImagePopup src="/images1/employees/emp_resu.png" alt="Employee create" />
...
3. Fill in:
   ...
   - **_Description:_** Additional notes.
    <ImagePopup src="/images1/employees/emp_resu1.png" alt="Employee create" />
4. Click **Create** to save the resume.

<ImagePopup src="/images1/employees/emp_resu2.png" alt="Employee create" />
